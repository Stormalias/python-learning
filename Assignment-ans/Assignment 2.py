...
Write a function “paytable” to calculate and print out the pay for part time staff based on the number of working hours.  
Input parameter to the function is number of hours (in whole number) . Your calculation of pay cannot be hardcoded in a formula, 
meaning that you have to use the for loop to process EACH hour. 

•	1st - 3rd hour: $6 per hour
•	4th - 6th hour: $7 per hour
•	7th hour onwards: $8 per hour

Part b
Write a Python program to ask the staff to enter the number of working hours and call the function “paytable”
'''
...
while True:
    try:
        worked = int(input("Enter the hours worked here: ")) # input variable
        print(f"Your pay for {worked} hours is ${paytable(worked)}") # output calling paytable function
        break
    except: #Exception handling
        print("Something went wrong. Did you enter a whole number?")
